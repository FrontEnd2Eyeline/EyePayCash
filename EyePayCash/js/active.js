...
//Rota el celular grande
$("#start-big").click(function() {
    $('.cellphone-big').toggleClass('cellphone-rotate');
  });
//Hace que el botón grande desaparezca
$("#start-big").click(function() {
    $('#start-big').toggleClass('animated zoomOut');
  });
//Hace que el chulo aparezca
$("#start-big").click(function() {
    $('#chulo-big').addClass('checkmark__check-big');
});
